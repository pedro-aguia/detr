...
def plot_confusion_matrix_old(cm, classes, path,
                          normalize=False,
...
def get_args_parser():
    ...
    parser.add_argument('--nms', default=1, type=int,
                        help='delete duplicate boxes')
...
@torch.no_grad()
def infer(images_path, model, postprocessors, device, output_path, nms, nms_thresh, save_images, show_imgs, json_path, iou_thresh):
    detecciones = []
    clases_reales = []
    clases_predecidas = []
    ...
    for img_sample in images_path:
        ...
        #numbers = [5, 2, 0, 1, 3, 4]
        colores = [(218, 0, 255),(0,255,75),(255,145,0),(145,255,0),(255,0,72),(255,0,72),(255,0,72),(255,0,72),(255,0,72),(0, 0, 0)]
...
if __name__ == "__main__":
    ...
    infer(image_paths, model, postprocessors, device, args.output_dir, args.nms, args.nms_thresh, args.save_images, args.show_imgs, args.json_path, args.iou_thresh)
